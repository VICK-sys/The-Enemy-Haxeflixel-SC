...
| `systems/enemy/EnemySpawner.hx` | edge spawn margins and spread, watchdog times, drive and progress thresholds, engage radii, local unstick rings, rescue distances |
