...
| `systems/weapons/GigaCharge.hx` | charge and ready volumes, glow ramp/base/wave, shine pulse speed, shine timing window, glint reach along the hammer |
...
| `systems/BossFinish.hx` | kill camera slow factor, zoom, lean and the three timings that make up its length |
