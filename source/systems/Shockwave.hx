...
class Shockwave
{
	static inline var WAVE_RADIUS:Float = 380;
	static inline var WAVE_TIME:Float = 0.45;
	...
	public function blast(cx:Float, cy:Float):Void
	{
		...
		ring.alpha = 0.8;
		waves.push(new Wave(cx, cy, ring));
	}
